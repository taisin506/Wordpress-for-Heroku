...
if ( ! function_exists( 'matangi_social_bar' ) ) {
	add_action( 'matangi_social_bar_action', 'matangi_social_bar' );
	function matangi_social_bar() {
		$socials_facebook_url  		=  matangi_get_setting( 'socials_facebook_url' );
		$socials_twitter_url   		=  matangi_get_setting( 'socials_twitter_url' );
		$socials_google_url    		=  matangi_get_setting( 'socials_google_url' );
		$socials_tumblr_url    		=  matangi_get_setting( 'socials_tumblr_url' );
		$socials_pinterest_url 		=  matangi_get_setting( 'socials_pinterest_url' );
		$socials_youtube_url   		=  matangi_get_setting( 'socials_youtube_url' );
		$socials_linkedin_url  		=  matangi_get_setting( 'socials_linkedin_url' );
		$socials_custom_icon_1  	=  matangi_get_setting( 'socials_custom_icon_1' );
		$socials_custom_icon_url_1  =  matangi_get_setting( 'socials_custom_icon_url_1' );
		$socials_custom_icon_2  	=  matangi_get_setting( 'socials_custom_icon_2' );
		$socials_custom_icon_url_2  =  matangi_get_setting( 'socials_custom_icon_url_2' );
		$socials_custom_icon_3  	=  matangi_get_setting( 'socials_custom_icon_3' );
		$socials_custom_icon_url_3  =  matangi_get_setting( 'socials_custom_icon_url_3' );
		$socials_mail_url     		=  matangi_get_setting( 'socials_mail_url' );
	?>
    <div class="matangi-social-bar">
    	<ul class="matangi-socials-list">
