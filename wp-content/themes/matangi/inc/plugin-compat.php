...
add_action( 'after_setup_theme', 'matangi_setup_woocommerce' );
/**
 * Set up WooCommerce
 *
 */
function matangi_setup_woocommerce() {
	...
	add_action( 'woocommerce_sidebar', 'matangi_construct_sidebars' );
}

if ( ! function_exists( 'matangi_woocommerce_start' ) ) {
	add_action( 'woocommerce_before_main_content', 'matangi_woocommerce_start', 10 );
	/**
	 * Add WooCommerce starting wrappers
	 *
	 */
	function matangi_woocommerce_start() { ?>
...
if ( ! function_exists( 'matangi_woocommerce_end' ) ) {
	add_action( 'woocommerce_after_main_content', 'matangi_woocommerce_end', 10 );
	/**
	 * Add WooCommerce ending wrappers
	 *
	 */
	function matangi_woocommerce_end() { ?>
						</div><!-- .entry-content -->
						<?php
						/**
...
if ( ! function_exists( 'matangi_woocommerce_css' ) ) {
	add_action( 'wp_enqueue_scripts', 'matangi_woocommerce_css', 100 );
	/**
	 * Add WooCommerce CSS
	 *
	 */
	function matangi_woocommerce_css() {
		if ( ! class_exists( 'WooCommerce' ) ) {
			return;
		}

		$mobile = apply_filters( 'matangi_mobile_media_query', '(max-width:768px)' );
...
if ( ! function_exists( 'matangi_bbpress_css' ) ) {
	add_action( 'wp_enqueue_scripts', 'matangi_bbpress_css', 100 );
	/**
	 * Add bbPress CSS
	 *
	 */
	function matangi_bbpress_css() {
...
if ( ! function_exists( 'matangi_buddypress_css' ) ) {
	add_action( 'wp_enqueue_scripts', 'matangi_buddypress_css', 100 );
	/**
	 * Add BuddyPress CSS
	 *
	 */
	function matangi_buddypress_css() {
...
if ( ! function_exists( 'matangi_beaver_builder_css' ) ) {
	add_action( 'wp_enqueue_scripts', 'matangi_beaver_builder_css', 100 );
	/**
	 ...
	 *
	 */
	function matangi_beaver_builder_css() {
