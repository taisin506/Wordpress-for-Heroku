...
define('MATANGI_THEME_URL','https://wpkoi.com/matangi-wpkoi-wordpress-theme/');
define('MATANGI_WPKOI_AUTHOR_URL','https://wpkoi.com/');
define('MATANGI_WPKOI_SOCIAL_URL','https://www.facebook.com/wpkoithemes/');
define('MATANGI_WORDPRESS_REVIEW','https://wordpress.org/support/theme/matangi/reviews/?filter=5');
define('MATANGI_DOCUMENTATION','https://wpkoi.com/docs/');
define('MATANGI_FONT_AWESOME_LINK','https://fontawesome.com/icons');
